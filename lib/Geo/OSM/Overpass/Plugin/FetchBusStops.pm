package Geo::OSM::Overpass::Plugin::FetchBusStops;
...
Geo::OSM::Overpass::Plugin::FetchBusStops - Plugin for L<Geo::OSM::Overpass> to fetch bus stop data in given area
...
its C<gorun()> method.
    ...
    # a bounding box centred at (lat,lon), 100 meter wide, 200 meter long
    $bbox->centred_at(35.1564547, 33.3740289, 100, 200);
    ...
    # 
    #   <node id="3290997139" lat="35.1564547" lon="33.3740289">
    #     <tag k="highway" v="bus_stop"/>
    #     <tag k="name" v="Archbishop Makariou C' Avenue 1"/>
    #     <tag k="name:en" v="Apoel"/>
    #   </node>
...
Please report any bugs or feature requests to C<bug-geo-osm-overpass-plugin-FetchBusStops at rt.cpan.org>, or through
the web interface at L<https://rt.cpan.org/NoAuth/ReportBug.html?Queue=Geo-OSM-Overpass-Plugin-FetchBusStops>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Geo::OSM::Overpass::Plugin::FetchBusStops
...
L<https://rt.cpan.org/NoAuth/Bugs.html?Dist=Geo-OSM-Overpass-Plugin-FetchBusStops>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Geo-OSM-Overpass-Plugin-FetchBusStops>

=item * CPAN Ratings

L<https://cpanratings.perl.org/d/Geo-OSM-Overpass-Plugin-FetchBusStops>

=item * Search CPAN

L<https://metacpan.org/release/Geo-OSM-Overpass-Plugin-FetchBusStops>
...
1; # End of Geo::OSM::Overpass::Plugin::FetchBusStops
